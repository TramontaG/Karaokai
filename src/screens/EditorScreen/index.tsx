...
export function EditorScreen() {
  ...
  return (
    <EditorPage>
      <EditorHeader model={behavior.editorHeaderModel} />
      ...
      <Workspace>
        ...
        <PlayerControls
          model={behavior.playerControlsModel}
          mixer={behavior.mixerPanelModel}
        />

        <EditorTimeline model={behavior.editorTimelineModel} />
      </Workspace>

      <EditorSidebar model={behavior.editorSidebarModel} />
      ...
      <Render when={behavior.exportDialogOpen}>
        <ExportDialog
          ...
          onInstrumentalVolumeChange={behavior.onExportInstrumentalVolumeChange}
