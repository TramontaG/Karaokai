...
export interface TimeSignatureMarkerProps {
  marker: TimeSignatureMarker;
  model: TimeSignaturesModel;
}
export function useTimeSignatureMarker({
  marker,
  model,
}: TimeSignatureMarkerProps) {
  ...
  return {
    label: `${marker.numerator}/${marker.denominator}`,
    ...
    popoverId,
    popover,
    moveLabel: t("editor.timeSignatureMove"),
    editLabel: t("editor.timeSignatureEdit"),
    deleteLabel: t("editor.timeSignatureDelete"),
    stop,
